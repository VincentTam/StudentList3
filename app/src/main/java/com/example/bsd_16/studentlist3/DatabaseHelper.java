...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "student_directory";
    ...
    public void onCreate(SQLiteDatabase db) {
        /*
         * Create the student table and populate it with sample data.
        ...
        values.put("homePhone", "617-219-2001");
        values.put("mobilePhone", "617-456-7890");
        values.put("email", "jsmith@email.com");
        db.insert("student", "lastName", values);

        values.put("firstName", "Robert");
        values.put("lastName", "Jackson");
        values.put("title", "VP Engineering");
        values.put("homePhone", "617-219-3333");
        values.put("mobilePhone", "781-444-2222");
        ...
        values.put("homePhone", "617-219-2002");
        values.put("mobilePhone", "987-654-3210");
        ...
        values.put("homePhone", "617-219-2003");
        values.put("mobilePhone", "987-654-7777");
        ...
        values.put("homePhone", "617-219-0000");
        values.put("mobilePhone", "617-666-7777");
        ...
        values.put("homePhone", "617-612-0987");
        values.put("mobilePhone", "617-123-9876");
        ...
        values.put("homePhone", "617-444-1122");
        values.put("mobilePhone", "617-555-3344");
